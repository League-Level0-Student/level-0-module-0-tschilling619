	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
	String input=JOptionPane.showInputDialog ("Do you want to kick or yell at the dragon");
